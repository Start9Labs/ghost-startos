...
update:
	curl -# https://code.jquery.com/jquery-3.5.1.min.js --output assets/scripts/local/jquery-3.5.1.min.js
	curl -# https://cdn.jsdelivr.net/npm/@tryghost/portal/umd/portal.min.js --output assets/scripts/local/portal.min.js
	curl -# https://cdn.jsdelivr.net/npm/@tryghost/sodo-search/umd/sodo-search.min.js --output assets/scripts/local/sodo-search.min.js
	curl -# https://cdn.jsdelivr.net/npm/@tryghost/sodo-search/umd/main.css --output assets/scripts/local/sodo-main.css
	curl -# https://cdn.jsdelivr.net/npm/@tryghost/comments-ui/umd/comments-ui.min.js --output assets/scripts/local/comments-ui.min.js
	curl -# https://cdn.jsdelivr.net/npm/@tryghost/comments-ui/umd/main.css --output assets/scripts/local/comments-main.css
